...
<html>
<head>
<!-- ControllerPath = "demo/stockInfo/stockInfoController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
    			...
    			<tr>
					...
					<td>
						<div class="input-group input-group-sm spinner" data-trigger="spinner">
							<input  class="form-control"  type="text" name="storageNumber" id="storageNumber" data-min="-99999999999999999999.99999999" data-max="99999999999999999999.99999999" data-step="1" data-precision="8">
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.stockInfo.closeDialog("insert");
		}
